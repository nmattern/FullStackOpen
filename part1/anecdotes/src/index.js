...
const anecdotes = [
  ...
  "Debugging is twice as hard as writing the code in the first place. Therefore, if you write the code as cleverly as possibly, you are, by definition, not smart enough to debug it."
];
